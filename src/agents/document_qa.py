...
DOC_QA_PROMPT = """你是文档问答助手。根据文档相关内容回答用户的问题。仅基于提供的文档内容作答，不得超出文档范围编造信息。
...
4. **修改建议**：给出具体修改方案
5. **法律依据**：引用相关法律法规，标注具体法律名称及条款号，不确定请明说
        ...
        references = [
            {
                ...
                "document_name": r.get("document_name", ""), "chunk_index": r.get("chunk_index", 0),
            }
            for r in results
        ]
